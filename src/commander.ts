...
export class GZoltarCommander implements vscode.TreeDataProvider<GZoltarCommand> {
    ...
    async run(key: string) {
        ...
        //
        var commandsDir = join(configPath, 'commands')
        ...
        const commandPath = join(configPath, 'commands');
        ...
        //
        fse.writeFileSync(join(commandPath,"listTestMethodCommand.txt"), listFunction(configPath, dependencies, folder.testFolder))
        ...
        //
        fse.writeFileSync(join(commandPath,"runTestMethodCommand.txt"), runFunction(configPath, dependencies, includes))
        ...
        //
        fse.writeFileSync(join(commandPath,"faultLocalizationCommand.txt"), reportFunction(configPath, this.reportOptions['Public Methods'], this.reportOptions['Static Constructors'], this.reportOptions['Deprecated Methods']))
